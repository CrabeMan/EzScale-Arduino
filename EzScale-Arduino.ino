...
#define BLE_OBJECT_NAME SCALE_PRODUCT_SUBNAME
...
static void setScaleStatus(const int status, const char* weight) {
  ...
  characteristic_scale_status_data[0] = 0x31;
  characteristic_scale_status_data[1] = 0x30;
...
void sendNotification(uint16_t handle, String json) {
  ...
  while (posCounter < jsonLength) {
    ...
    Serial.println(str2);
    uint8_t data[20] = {outMsgNum+'0', batchCounter+'0', 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
